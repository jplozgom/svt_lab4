...
#define PanSource	"Pessimistic.pml"
...
#define _nstates6	7	/* alwaysEventuallyCustomersBuyingProcessDone */
#define minseq6	96
#define maxseq6	101
#define _endstate6	6

#define _nstates5	7	/* notAvailablePlusFlightFullEqualsNthTriangle */
#define minseq5	90
#define maxseq5	95
#define _endstate5	6
...
#define _nstates1	18	/* client */
#define minseq1	37
#define maxseq1	53
#define _endstate1	17

#define _nstates0	38	/* crs */
#define minseq0	0
#define maxseq0	36
...
struct Seat { /* user defined type */
	uchar seatStatus;
	int customerId;
};
typedef struct P6 { /* alwaysEventuallyCustomersBuyingProcessDone */
...
typedef struct P5 { /* notAvailablePlusFlightFullEqualsNthTriangle */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, seatNumber) - 1*sizeof(int))

#define Pcrs	((P0 *)_this)
typedef struct P0 { /* crs */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#endif
	uchar message;
	int notAvailableSeatCount;
	int flightFullMessageCount;
	int assignedSeats;

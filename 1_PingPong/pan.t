...
{	Trans *T;
	...
	trans[6][1]	= settr(76,0,17,3,0,"(((((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1])==2))", 1, 2, 0);
	trans[6][2]	= settr(77,0,17,1,0,"goto accept_S6", 0, 2, 0);
	trans[6][3]	= settr(78,0,22,4,0,"(((((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1])==1))", 1, 2, 0);
	trans[6][4]	= settr(79,0,22,1,0,"goto accept_S11", 0, 2, 0);
	trans[6][5]	= settr(80,0,27,5,0,"(((((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1])==0))", 1, 2, 0);
	...
	trans[6][15]	= settr(90,0,17,7,0,"(((((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1])==2))", 1, 2, 0);
	...
	trans[6][20]	= settr(95,0,22,8,0,"(((((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1])==1))", 1, 2, 0);
	...
	trans[6][25]	= settr(100,0,27,9,0,"(((((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1])==0))", 1, 2, 0);
	...
	trans[5][1]	= settr(58,0,6,12,12,"((!(((((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1])==0))||!(1)))", 1, 2, 0); /* m: 2 -> 6,0 */
	reached5[2] = 1;
	...
	trans[4][1]	= settr(45,0,10,15,0,"(!(((((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1])==1)))", 1, 2, 0);
	...
	T = T->nxt	= settr(31,0,4,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(31,0,8,0,0,"IF", 0, 2, 0);
/*->*/	trans[2][4]	= settr(25,32,5,22,22,"D_STEP73", 1, 505, 0);
	trans[2][5]	= settr(26,0,15,23,23,"printf('P2 receives ball from ref')", 0, 2, 0); /* m: 12 -> 0,15 */
	reached2[12] = 1;
	trans[2][11]	= settr(32,0,12,1,0,".(goto)", 0, 2, 0); /* m: 12 -> 0,15 */
	reached2[12] = 1;
/*->*/	trans[2][8]	= settr(29,32,9,24,24,"D_STEP76", 1, 503, 0);
	trans[2][9]	= settr(30,0,15,25,25,"printf('P2 receives ball from P1')", 0, 2, 0); /* m: 12 -> 0,15 */
	reached2[12] = 1;
	trans[2][12]	= settr(33,0,15,26,26,"printf('P2 receives from P1, send ball ... P2 -> P1')", 0, 2, 0);
/*->*/	trans[2][15]	= settr(36,32,16,27,27,"D_STEP83", 1, 4, 0);
	trans[2][18]	= settr(39,0,19,1,0,"break", 0, 2, 0);
	trans[2][19]	= settr(40,0,0,28,28,"-end-", 0, 3500, 0);

	/* proctype 1: Player1 */

	trans[1] = (Trans **) emalloc(21*sizeof(Trans *));

	trans[1][1]	= settr(2,0,17,29,0,"printf('hi I am player 1')", 0, 2, 0);
	...
	T = T->nxt	= settr(11,0,4,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(11,0,8,0,0,"IF", 0, 2, 0);
/*->*/	trans[1][4]	= settr(5,32,5,30,30,"D_STEP47", 1, 505, 0);
	trans[1][5]	= settr(6,0,12,31,31,"printf('P1 receives ball from ref')", 0, 2, 0);
	trans[1][11]	= settr(12,0,12,1,0,".(goto)", 0, 2, 0);
/*->*/	trans[1][8]	= settr(9,32,9,32,32,"D_STEP50", 1, 504, 0);
	trans[1][9]	= settr(10,0,12,33,33,"printf('P1 receives from P2')", 0, 2, 0);
	trans[1][12]	= settr(13,0,13,34,0,"printf('balls %d \\n',(((len(chP1ToP2)+len(chP2ToP1))+pActiveBalls[0])+pActiveBalls[1]))", 1, 2, 0);
	trans[1][13]	= settr(14,0,16,35,0,"printf('P1 receives from P2, send ball ... P1 -> P2')", 0, 2, 0);
/*->*/	trans[1][16]	= settr(17,32,17,36,36,"D_STEP57", 1, 3, 0);
	trans[1][19]	= settr(20,0,20,1,0,"break", 0, 2, 0);
	trans[1][20]	= settr(21,0,0,37,37,"-end-", 0, 3500, 0);

	/* proctype 0: Referee */

	trans[0] = (Trans **) emalloc(3*sizeof(Trans *));

	trans[0][1]	= settr(0,0,2,38,38,"chRefToPs!BALL", 1, 5, 0);
	trans[0][2]	= settr(1,0,0,39,39,"-end-", 0, 3500, 0);
	/* np_ demon: */
